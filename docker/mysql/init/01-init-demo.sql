-- Delivery init SQL generated from current backend/src/main/resources/db/migration/*.sql
SET NAMES utf8mb4;
...
-- SOURCE: backend/src/main/resources/db/migration/V2__init_demo_data.sql
...
-- SOURCE: backend/src/main/resources/db/migration/V3__study_plan_and_material_modules.sql
...
-- SOURCE: backend/src/main/resources/db/migration/V4__exam_module_mvp.sql
...
-- SOURCE: backend/src/main/resources/db/migration/V5__forum_and_school_info_modules.sql
...
-- SOURCE: backend/src/main/resources/db/migration/V6__stats_and_system_management.sql
...
-- SOURCE: backend/src/main/resources/db/migration/V7__productize_copy_and_refresh_demo_data.sql
